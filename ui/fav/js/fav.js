    ...
    for (var i in imdbIdsList){
        ...
        fetch(`/data/item/${imdbIdsList[i]}.json`)
         ...
         .then((title)=>{
            ...
            <div class="fav_logo_space"> <img src="../ue/a/loved.png" width="100%" height="100%"></img> </div>
            </div>
...
if(getAllFav().length==0){

    $("results").innerHTML="<div class='no_fav'>  المفضلة فارغة  <img src='../ue/a/eb.png' height='50px'></img>";

}else{

    drawResults(getAllFav());
